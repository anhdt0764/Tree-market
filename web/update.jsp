...
<%-- 
    Document   : update
    Created on : Mar 3, 2024, 12:40:22 PM
    Author     : ducnk
--%>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalTitleCreate">Chỉnh sửa sản phẩm</h5>
                                    <a type="button" href="admin" class="close" data-dismiss="modal" aria-label="Close">
                                ...
                                <div >
                                    ...
                                    <form method="post" action="update">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="des"  value="${p.description}">
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Product Id<span style="color: red">*</span></label>
                                                    <input type="text" class="form-control" readonly="" name="Id" value="${p.id}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Product Image<span style="color: red">*</span></label>
                                            <input type="text" class="form-control" name="inputImg" value="${p.img}">
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="modal-footer">
                                            <a type="button" href="admin" class="btn btn-secondary" >Close</a>
                                            <div id="submitButtons">
                                                <input type="submit" class="btn btn-primary"  value="Update Sản phẩm">
                                            </div>
