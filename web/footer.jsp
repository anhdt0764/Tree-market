<%-- 
    Document   : footer
    Created on : Feb 27, 2024, 10:12:55 AM
    Author     : ducnk
--%>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-12 col-12">
                        <div class="top-footer-inner">
                            ...
                            <ul class="f-adress">
                                <li><b>Địa chỉ:</b> Tiền Hải, Thái Bình</li>
                                <li><b>Điện thoại:</b> 0123 456 789</li>
                                <li><b>Email:</b> AnhDTHE172647@fpt.edu.com</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-12 col-12">
        ...
        <div class='footer' id='footer'>
            ...
            <div class='credit-wrapper main-container container' id='credit-wrapper' itemprop='hasPart'>
                <p class='credit-content' itemprop='isPartOf'>
                    ...
                    <span class='creator' style='opacity:0;'>Designed By <a href='https://www.quochieu.com' rel='noopener' target='_blank'>Do Tuan Anh</a></span>
                </p>
            </div>
        </div>
