<%-- 
    Document   : updatecate
    Created on : Mar 3, 2024, 4:53:23 PM
    Author     : ducnk
--%>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalTitleMenu">Chỉnh sửa category</h5>
                                    <a type="button" class="close" href="admin" data-dismiss="modal" aria-label="Close">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="post" action="updatecate">
                                        <div class="row">
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly="" type="text" class="form-control" name="menuId" value="${c.id}">
                                                </div>
                                            </div>
                                            <div class="col-sm-10">
                                                <div class="form-group">
                                        ...
                                        <div class="modal-footer">
                                            <a type="button" href="admin">Close</a>
