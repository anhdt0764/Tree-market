<%-- 
    Document   : updateacc
    Created on : Mar 4, 2024, 10:22:54 PM
    Author     : ducnk
--%>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <!-- body -->
                                    <form method="post" action="updateacc">
                                        <div class="form-group">
                                            <label for="e_username">UserName</label>
                                            <input type="text" class="form-control" name="e_username" readonly="" value="${acc.name}">
                                        </div>
                                            <input type="text" hidden=""class="form-control" name="id" readonly="" value="${acc.uId}">
                                        <div class="form-group">
                                            <label for="e_name">Name</label>
                                            <input type="text" class="form-control" name="e_name" readonly="" value="${acc.uName}">
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="e_password">Password</label>
                                                    <input type="password" class="form-control" readonly="" name="e_password" value="${acc.pass}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="e_role">Role</label>
                                                    <select class="form-control" name="e_role">
                                                        <option value="1" ${(acc.role==1)?"selected":""}>Admin</option>
                                                        <option value="2" ${(acc.role!=1)?"selected":""}>User</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            <a type="button" href="admin" class="btn btn-secondary" data-dismiss="modal">Close</a>
