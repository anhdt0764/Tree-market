                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="updatecou" method="post">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="couponCode" value="${c.name}" >
                                                        </div>
                                                            <input hidden="" type="text" class="form-control" name="id" value="${c.id}" >
                                                        <div class="form-group">
                                                            <label for="couponDetail">Detail</label>
                                                            <input type="text" class="form-control" name="couponDetail" value="${c.detail}">
                                                        </div>


                                                        <div class="form-group">
                                                            <label for="couponValue">Value</label>
                                                            <input type="text" class="form-control" name="couponValue" value="${c.value}" >
                                                        </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <div id="submitButtonCoupon">
                                                                <input type="submit" class="btn btn-primary" value="Chỉnh sửa coupon">
                                                            </div>
